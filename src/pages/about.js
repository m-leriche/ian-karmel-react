    ...
    <ThemeProvider theme={theme}>
      ...
      <div className={`${styles.container} fadeIn`}>
        <div className={styles.about}>
          ...
          <p>Hometown hero, Ian played an instrumental role in Portland&#39;s comedy renaissance and was voted Portland&#39;s Funniest Person in their inaugural contest. He is also beloved for his appearances on IFC&#39;s <strong>Portlandia</strong>, the Blazers wrap-up show <strong>Talkin&#39; Ball</strong>, and long running weekly column in the <strong>Portland Mercury</strong>, <i>Everything as Fuck</i>. With roots in improv and theatre, Ian&#39;s training includes The Groundlings and the Upright Citizens Brigade.</p>
          <p>Ian currently tours as much as possible and regularly performs around Los Angeles.</p>
        </div>
      </div>
