...
const Menu = ({ open }) => {
  return (
    <StyledMenu open={open}>
      {/* <Link legacyBehavior={true} href="https://bookshop.org/p/books/t-shirt-swim-club-the-struggle-stretch-marks-and-solitude-of-being-fat-in-a-world-made-for-thin-people-ian-karmel/20601105?ean=9780593580929">
      ...
      <div className="socials">
        <a className="social" href="https://www.instagram.com/iankarmel/" target="_blank" rel="noopener noreferrer">
        ...
        <a className="social" href="https://www.x.com/iankarmel/" target="_blank" rel="noopener noreferrer">
        ...
        <a className="social" href="https://www.tiktok.com/@iankarmel" target="_blank" rel="noopener noreferrer">
        ...
        <a className="social" href="https://www.youtube.com/results?search_query=%23iankarmel" target="_blank" rel="noopener noreferrer">
